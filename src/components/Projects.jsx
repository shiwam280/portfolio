        ...
        {PROJECTS.map((project) => (
          ...
          >
            ...
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className="absolute gap-2 inset-0 flex flex-col items-center justify-center text-white opacity-0 backdrop-blur-lg transition-opacity duration-500 group-hover:opacity-100"
            >
